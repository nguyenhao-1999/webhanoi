        ...
        <div class="row">
          <div class="col-md-9">
            <fieldset class="form-group">
              ...
              <input type="text" name="name" class="form-control" id="tensp" required placeholder="Tên menu">
            </fieldset>
            <fieldset class="form-group">
              <label for="link">Liên kết</label>
              <textarea name="detail" class="form-control" id="link" required rows="7"></textarea>
            </fieldset>
            <fieldset class="form-group">
              <label for="mota">Chủ đề cha</label>
