      ...
      <div class="card-block p-3">
        ...
        <div class="row">
          ...
          <div class="col-md-3">
            ...
            <fieldset class="form-group">
            	<label>Thêm vào logo trang web</label>
                <img src="../public/images/noImg.jpg" alt="sss" id="uml_img_test" style="width: 150px;height: auto; border: 1px #eee solid;">
            ...
            <fieldset class="form-group">
            	<label>Thêm vào icon trang web</label>
                <img src="../public/images/noImg.jpg" alt="sss" id="uml_icon_test" style="width: 150px;height: auto; border: 1px #eee solid;">
                <div class="input-group mb-3">
                  <input type="hidden" id="
                  " name="img" class="form-control" required aria-describedby="basic-addon2">
                  <div class="input-group-append">
                    <button type="button" id="ckfinder-icon-1">Chọn hình</button>
                </div>
              </div>
              </fieldset>
...
<script>
  var button1 = document.getElementById( 'ckfinder-icon-1' );
