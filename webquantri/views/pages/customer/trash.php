    ...
    <div class="card-header">
      <div class="row">
        ...
        <div class="col-md-6 text-right">
         <a href="index.php?option=customer" class="btn btn-danger"><i class="fas fa-arrow-left"></i> Thoát</a>
       </div>	
     </div>
   </div>
   <div class="card-body">
      ...
      <tbody>
        <?php foreach($list as $rlist): ?>
          <tr>
            ...
            <td>
              <a class="btn btn-sm btn-success" href="index.php?option=customer&cat=retrash&id=<?php echo $id; ?>"><i class="fas fa-reply"></i></a>
              <a class="btn btn-sm btn-danger" href="index.php?option=customer&cat=delete&id=<?php echo $id; ?>"><i class="far fa-trash-alt"></i></a>
            </td>
          </tr>
        <?php endforeach; ?>
